...
(define-key org-present-mode-keymap (kbd "C-d C-=") 'org-present-big)
(define-key org-present-mode-keymap (kbd "C-d C--") 'org-present-small)
(define-key org-present-mode-keymap (kbd "C-d C-q") 'org-present-quit)
(define-key org-present-mode-keymap (kbd "C-d C-r") 'org-present-read-only)
(define-key org-present-mode-keymap (kbd "C-d C-w") 'org-present-read-write)
