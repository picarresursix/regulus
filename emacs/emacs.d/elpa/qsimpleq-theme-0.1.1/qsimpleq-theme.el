...
(let* ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   ;; cperl
   `(cperl-array-face ((,class (:background nil :foreground nil :inherit font-lock-function-name-face :weight bold))))
   `(cperl-hash-face  ((,class (:background nil :foreground nil :inherit font-lock-warning-face :slant italic  :weight bold))))
   `(cperl-nonoverridable-face ((,class (:foreground nil :inherit font-lock-type-face))))
   ...
   ;; auto-complete
   `(ac-candidate-face ((,class (:background ,qsimpleq-hl :foreground ,qsimpleq-fg ))))
   ...
   ;; rainbow-delimiters
   `(rainbow-delimiters-depth-1-face ((,class (:foreground ,cyan :weight bold))))
   `(rainbow-delimiters-depth-2-face ((,class (:foreground ,yellow :weight bold))))
   `(rainbow-delimiters-depth-3-face ((,class (:foreground ,violet :weight bold))))
   `(rainbow-delimiters-depth-4-face ((,class (:foreground ,orange :weight bold))))
   `(rainbow-delimiters-depth-5-face ((,class (:foreground ,green :weight bold))))
   `(rainbow-delimiters-depth-6-face ((,class (:foreground ,yellow :weight bold))))
   `(rainbow-delimiters-depth-7-face ((,class (:foreground ,violet :weight bold))))
   `(rainbow-delimiters-depth-8-face ((,class (:foreground ,orange :weight bold))))
   ...
   `(rainbow-delimiters-depth-11-face ((,class (:foreground ,violet :weight bold))))
   `(rainbow-delimiters-depth-12-face ((,class (:foreground ,orange :weight bold))))
   ...
   `(zjl-hl-elisp-number-face ((,class (:foreground nil :inherit font-lock-constant-face :weight bold))))
   ...
   `(zjl-hl-number-face ((,class (:foreground nil :inherit zjl-hl-elisp-number-face :weight bold)))))
